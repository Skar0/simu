...
\subsubsection{Tests}
Tous les tests référencés dans ce rapport sont implémentés dans le module $tests$. Le programme qui lance les tests sont \textit{main\_tests.py} pour ceux de la première section et \textit{pirand\_main\_tests.py} pour ceux de la deuxième.
